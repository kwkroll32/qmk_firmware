...
*/
  [BASE] = KEYMAP(
      ...
      MO(1),     KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_NO,     KC_ENT , KC_PGUP,
      KC_LSFT,KC_NO,KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH,     KC_RSFT, KC_UP , RGUI_T(KC_PGDN),
      CTL_T(KC_HOME), KC_LGUI, KC_LALT, KC_SPACE,   KC_RALT,CTL_T(KC_END),KC_NO, KC_LEFT,KC_DOWN, KC_RGHT
      ),
...
*/
  [FN_1] = KEYMAP(
      ...
      MO(1), KC_LEFT, KC_DOWN, KC_RGHT, KC_TRNS, KC_TRNS, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_VOLU,
      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_PGDN, KC_PGUP, KC_TRNS, KC_TRNS, KC_PGUP, KC_VOLD,
      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, MO(2), KC_TRNS, KC_HOME, KC_PGDN, KC_END
      ),


/* Function layer for utility
    ,-----------------------------------------------------------------------------------------------.
    |     |     |     |     |     |     |     |     |     |     |     |     |     |     |     |flash|
    |-----------------------------------------------------------------------------------------------|
    |       |     |     |     |     |     |     |     |     |     |     |     |     |         |     |
