...
static keyframe_animation_t resume_animation = {
    ...
    .loop = false,
    .frame_lengths = {0, MS2ST(1000), MS2ST(5000), 0},
    .frame_functions = {keyframe_enable_lcd_and_backlight, keyframe_animate_backlight_color, keyframe_no_operation, enable_visualization},
};
...
void initialize_user_visualizer(visualizer_state_t* state) {
    ...
    start_keyframe_animation(&led_on_animation);
}
